    ...
    <section class="rle-showcase" id="<?php echo esc_attr($atts['section_id']); ?>" dir="rtl">
        ...
        <div class="rle-overlay" data-rle-overlay="about" aria-hidden="true">
            ...
            <div class="rle-overlay__dialog" role="dialog" aria-modal="true" aria-labelledby="rle-about-title">
                ...
                <div class="rle-overlay__content">
                    ...
                    <h2 class="rle-overlay__title rle-overlay__title--image" id="rle-about-title">
                        <img src="/wp-content/uploads/2026/08/c5f80239-42ad-44e3-9c88-b6f4e58d1c65.png" alt="אודות">
                    </h2>
        ...
        <div class="rle-overlay" data-rle-overlay="contact" aria-hidden="true">
            ...
            <div class="rle-overlay__dialog" role="dialog" aria-modal="true" aria-labelledby="rle-contact-title">
                ...
                <div class="rle-overlay__content">
                    <p class="rle-overlay__eyebrow">רועי לוי</p>
                    <h2 class="rle-overlay__title rle-overlay__title--image" id="rle-contact-title">
                        <img src="/wp-content/uploads/2026/08/34d21602-bcc8-415f-ae16-f0bac3e3f469.png" alt="צרו קשר">
                    </h2>
                    ...
                    <a class="rle-contact__wa-icon" data-rle-whatsapp="<?php echo esc_attr($whatsapp_digits); ?>" href="<?php echo $whatsapp_digits ? esc_url('https://wa.me/' . $whatsapp_digits) : '#'; ?>" target="_blank" rel="noopener noreferrer" aria-label="יצירת קשר בוואטסאפ">
